...
class RpcController extends Controller
{
    ...
    public function loginByQqgame(AuthService $service, RpcParams $params)
    {
        return $service->loginByQqgame(
            $params['app_name'],
            $params['code'],
            $params->get('userInfo')
        );
    ...
    public function loginByApple(AuthService $service, RpcParams $params)
    {
        return $service->loginByApple(
            $params['app_name'],
            $params['code'],
            $params->get('userInfo')
        );
